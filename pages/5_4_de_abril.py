...
data = pd.read_csv('https://raw.githubusercontent.com/sandroormeno/app_for_running/main/data/GPS-4-4-2023.CSV') # GPS.CSV
...
view_data = st.sidebar.radio("What data do you want to see?", ("Run down", "Run Up", "Both"), 0, key=4)
