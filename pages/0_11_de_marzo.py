...
data = pd.read_csv('https://raw.githubusercontent.com/sandroormeno/app_for_running/main/data/GPS-3-11-2023.CSV') # GPS.CSV
...
view_data = st.sidebar.radio("What data do you want to see?", ("Run down", "Run Up", "Both"), 0, key=-3)
...
def show_maps(view, samples):
    ...
    my_colors = ['#992708', '#eb3c0c', '#ff4917', '#EF553B', '#faa328', '#fad028', '#fae528', '#fcef35', '#faf328', '#effa28', '#dbfa28', '#cdfa28', '#adfa28', '#85f714', '#10e63b', '#09d932', '#08cf2f', '#07b329', '#069e24', '#048a1e', '#04801c', '#036917']
    my_Speed = ['0.7 m/s', '1.0 m/s', '1.1 m/s', '1.2 m/s','1.3 m/s','1.4 m/s','1.5 m/s','1.6 m/s','1.7 m/s','1.8 m/s','1.9 m/s', '2.0 m/s', '2.1 m/s', '2.2 m/s', '2.3 m/s', '2.4 m/s', '2.5 m/s', '2.6 m/s', '2.7 m/s', '2.8 m/s', '2.9 m/s',  '3.0 m/s']
