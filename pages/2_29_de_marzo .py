...
data = pd.read_csv('https://raw.githubusercontent.com/sandroormeno/app_for_running/main/data/GPS-3-29-2023.CSV') # GPS.CSV
...
#with st.sidebar:
#   view_data = a.radio("What data do you want to see?", ("Run down", "Run Up", "Both"), 0, key=1)            
view_data = st.sidebar.radio("What data do you want to see?", ("Run down", "Run Up", "Both"), 0, key=1)
